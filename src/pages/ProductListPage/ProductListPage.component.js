...
import { CategoryHeaderWrapper, ProductListWrapper, CategoryItemsListWrapper } from "./styledcomponents";
import FontProperty from "../../components/FontProperty";
import CategoryItemsList from "../../components/Category/CategoryItems";
  ...
  renderHelmet() {
    ...
    return (
      <Helmet>
        <html lang="en" />
        <title>
          {categoryName}, Minimalistic_Store

        </title>
        <meta
          name="description"
          content={`Minimalistic_Store ${categoryName}`}
        />
      ...
      <>
        <ProductListWrapper>
          ...
          <CategoryItemsListWrapper>
            {[...Array(rowSekeletonProducts)]?.map((i) => (
              <div key={i} id="card">
  ...
  renderProductListPage() {
    ...
    return (
      <>
        ...
        <CategoryItemsList products={products} />
      </>
    );
  }
